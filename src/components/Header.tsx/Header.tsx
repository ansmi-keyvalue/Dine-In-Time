...
export default function Header({
  ...
  return (<header className="justify-between items-start self-center flex w-full max-w-[1420px] gap-2 mt-12 max-md:max-w-full max-md:flex-wrap max-md:justify-center ">
        <div className="flex">
